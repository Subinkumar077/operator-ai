...
type PrioritiesKeys = 'HIGH' | 'MEDIUM' | 'LOW' | 'TBD';
export const PRIORITIES: Record<PrioritiesKeys, { key: PrioritiesKeys; display: string; color: string }> = {
