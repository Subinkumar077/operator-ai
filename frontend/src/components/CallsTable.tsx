              ...
              <VStack w={{ base: 'full', lg: '2xl' }} alignItems="left" m="2" alignSelf={'flex-start'}>
                ...
                {data.geocode && (
                  <Image
                    ...
                    w={'3xl'}
                    src={`https://staticmap.openstreetmap.de/staticmap.php?center=${data.geocode?.lat},${data.geocode?.lng}&zoom=16&size=500x150&maptype=mapnik&markers=${data.geocode?.lat},${data.geocode?.lng},lightblue`}
                  />
                )}
              </VStack>
